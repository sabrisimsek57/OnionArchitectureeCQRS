...
{
    public class CreateAppointmentCommandRequestValidator : AbstractValidator<CreateAppointmentCommandRequest>
    {
        public CreateAppointmentCommandRequestValidator()
        {
